		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comasintstarapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comasintstarapp1-display": {
								"semanticObject": "comasintstarapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.asint.star.app1",
									"url": sap.ui.require.toUrl("com/asint/star/app1")
								}
							}
						}
					}
